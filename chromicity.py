...
class ApplicationVisualizer:
    def __init__(self, imgData):
        ...
        G_map.imshow(G_data, cmap='Green', interpolation=None)
        B_map.imshow(B_data, cmap='Blue', interpolation=None)
        ...
        self.MainApplication.title('Chromaticity tool')
...
class ApplicationICCT:
    ...
    def __init__(self):
        ...
        self.AppNameLabel.config(anchor='w', font='{Helvetica} 30 {bold}', text='Chromaticity Tool')
        self.AppNameLabel.place(anchor='n', x='215', y='35')

        self.AppCreditLabel = ttk.Label(self.MainApplicationFrame)
        self.AppCreditLabel.config(text='')
        ...
        self.ClearFileButton.config(state='disabled', text='Remove', width='7')
        self.ClearFileButton.place(anchor='e', x='395', y='35')

        self.ModeTextLabel = ttk.Label(self.ControlFrame, text='Modes')
        ...
        self.ProcessButton = ttk.Button(self.ControlFrame, text='Apply & View', command=self.applyImageFilter)
        ...
        self.ControlFrame.config(height='595', text='Tool Box', width='430')
